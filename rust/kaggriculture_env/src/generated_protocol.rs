...
pub const RULE_TABLES_SHA256: &str = "85839a723c63d31a1cfcbe2048d37ae418469bee4e3c16419e0c2561ed80e1e7";
pub const BOARD_SIZE: usize = 10;
pub const MAX_HANDS: usize = 240;
...
pub const OBS_SIZE: usize = 8766;
pub const OBS_MARKET_INVENTORY: usize = 8676;
pub const OBS_MARKET_PRICES: usize = 8685;
pub const OBS_SHOPS: usize = 8696;
pub const OBS_SHED: usize = 5767;
pub const OBS_SEEDS: usize = 5779;
pub const OBS_INVENTORY: usize = 5784;
pub const OBS_ANIMAL_INVENTORY: usize = 5793;
pub const OBS_HAND_INVENTORY: usize = 5796;
